    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: SITE.name,
          legalName: "Afri Tech Systems Limited",
          alternateName: ["AfriTech Systems", "Afri Tech Systems"],
          url: SITE_URL,
          logo: `${SITE_URL}/favicon.png`,
          slogan: SITE.tagline,
          email: SITE.email,
          telephone: SITE.phones[0],
          address: { "@type": "PostalAddress", streetAddress: "Plot No. 1907, Flat 01, MJ Zulu Street, Ibex Hill", addressLocality: "Lusaka", addressRegion: "Lusaka Province", addressCountry: "ZM" },
          areaServed: "Africa",
          description: "Enterprise automation, custom ERP, school management and industrial digitization across Pan-Africa.",
          sameAs: ["https://www.linkedin.com/company/afritechsystemsltd/"],
        }),
      },
    ],
  }),
