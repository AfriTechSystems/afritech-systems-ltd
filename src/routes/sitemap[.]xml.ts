    ...
    handlers: {
      GET: async () => {
        ...
        const entries: SitemapEntry[] = [
          ...
          { path: "/solutions/enterprise-erp", changefreq: "monthly", priority: "0.9" },
          { path: "/solutions/school-management", changefreq: "monthly", priority: "0.9" },
          { path: "/solutions/automation-dashboards", changefreq: "monthly", priority: "0.9" },
          ...
          { path: "/industries/logistics", changefreq: "monthly", priority: "0.8" },
